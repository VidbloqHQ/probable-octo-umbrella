 ...
 */
export const updateParticipantLeftTime = async (req: TenantRequest, res: Response) => {
  const { streamId } = req.params;
 ...
 */
export const updateParticipantPermissions = async (req: TenantRequest, res: Response) => {
 ...
 */
export const getParticipantScores = async (req: TenantRequest, res: Response) => {
  const { streamId } = req.params;
  const tenant = req.tenant;
