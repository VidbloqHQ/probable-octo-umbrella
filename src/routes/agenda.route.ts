...
router.get(
  "/stream/:streamId",
  singletonController("getStreamAgenda", getStreamAgenda)
);
router.put(
  "/:agendaId",
  singletonController("updateStreamAgenda", updateStreamAgenda)
);
// router.get("/:agendaId", singletonController('getAgendaById', getAgendaById));
router.get("/:agendaId", getAgendaById);
router.delete(
  "/:agendaId/:wallet",
  singletonController("deleteAgenda", deleteAgenda)
);
