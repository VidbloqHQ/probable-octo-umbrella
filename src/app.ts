...
const corsOptions = {
  origin: true, // This allows any origin and sets the Access-Control-Allow-Origin header properly
...
// Alternative manual preflight handler if the above doesn't work
app.use((req: Request, res: Response, next) => {
