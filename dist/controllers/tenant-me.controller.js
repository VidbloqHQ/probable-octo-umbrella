...
export const updateTenant = async (req, res) => {
    try {
        ...
        const tenantId = req.tenant.id;
        // Extract updatable fields from request body
        const { name, theme, primaryColor, secondaryColor, logo, shortLogo, templateId, rpcEndpoint, networkCluster, defaultStreamType, defaultFundingType, enabledStreamTypes, authorizedDomains, } = req.body;
        // Prepare the data for update
        const updateData = {};
        // Only include fields that are provided
        if (name !== undefined)
