 ...
 */
async function getAccountInfoWithRetry(connection, account, maxRetries = 3) {
...
export const submitTransaction = async (req, res) => {
    ...
    try {
        ...
        if (streamId) {
            const streamExists = await executeQuery(() => db.stream.findFirst({
                where: {
                    id: streamId,
                    tenantId: tenant.id,
                },
...
export const getTransactionStatus = async (req, res) => {
    ...
    try {
        ...
        const transaction = await executeQuery(() => db.transaction.findFirst({
            where: {
                signature,
                tenantId: tenant.id,
            },
 ...
 */
export const getStreamTransactionHistory = async (req, res) => {
