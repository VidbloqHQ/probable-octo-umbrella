 ...
 */
export const checkTokenAccountBalance = async (connection, walletAddress, tokenName, requiredAmount) => {
    try {
 ...
 */
export const checkSolBalance = async (connection, walletAddress) => {
    try {
        const wallet = new PublicKey(walletAddress);
